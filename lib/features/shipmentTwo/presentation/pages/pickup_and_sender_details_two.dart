...
class PickUpAndSenderDetailsTwo extends StatefulWidget {
  const PickUpAndSenderDetailsTwo({super.key});

  @override
  State<PickUpAndSenderDetailsTwo> createState() => _PickUpAndSenderDetailsTwoState();
}

class _PickUpAndSenderDetailsTwoState extends State<PickUpAndSenderDetailsTwo> {
